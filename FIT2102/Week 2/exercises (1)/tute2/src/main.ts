...
const binaryTree = <T extends Object>(
  ...
  left?: BinaryTree<T>,
  right?: BinaryTree<T>
): BinaryTree<T> => binaryTree(data, left, right);
...
//   // return current + (node.left == undefined ? prettifyBinaryTree(node.right): "\n|-" + prettifyBinaryTree(node.left))

//   return (node.left != undefined ? (current + "\n|-" + prettifyBinaryTree(node.left))
//                                 : current) + 
//          (node.right != undefined ? (current + "\n|-" + prettifyBinaryTree(node.right))
//                                 : current);
// }
