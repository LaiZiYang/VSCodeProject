 ...
 */
function aFunction(v=2){
  return v*2
};

const anonymousFunction = function(v=2){
  return v*2
};

const arrowFunction = (v=2)=> v*2;
 ...
 */
const printArray = arr=> arr.forEach(console.log);
...
const projectEulerProblem1Again = () => {
  return range(1000).filter(x => x%3==0 || x%5==0).reduce((acc, x) => acc + x, 0)
}
